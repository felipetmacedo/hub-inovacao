...
function Chat({ initialConversation }) {
  ...
  return (
    <div style={{flex:1,display:'flex',flexDirection:'column',background:'#f4f8ff',overflow:'hidden',position:'relative'}}>
      {/* Toast */}
      {notif && (
      ...
      <div style={{flex:1,display:'flex',overflow:'hidden'}}>
        {/* Conversation list */}
        <div style={{width:270,flexShrink:0,borderRight:'1px solid rgba(0,60,180,0.1)',background:'#ffffff',overflow:'auto',display:'flex',flexDirection:'column'}}>
